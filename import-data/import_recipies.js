...
async function importRecipies() {
  try {
    const response = await axios.get('https://dummyjson.com/recipies');
    const recipies = response.data.recipies || response.data;
    ...
    console.error('Error importing recipies:', error);
  } finally {
